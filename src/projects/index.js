    ...
    <div className="ui vertical stripe container">
      <div className="ui two column stackable doubling grid">
        <div className="column">
          <a href="https://github.com/Grumlen/Notes-Application"><div className="ui animated fluid fade button" tabIndex="0">
        ...
        <div className="column">
          <a href="https://github.com/Grumlen/Chart-App"><div className="ui animated fluid fade button" tabIndex="0">
        ...
        <div className="column">
          <a href="https://grumlen.github.io/Notes-App-React/"><div className="ui animated fluid fade button" tabIndex="0">
        ...
        <div className="column">
          <a href="https://github.com/Grumlen/Notes-Server"><div className="ui animated fluid fade button" tabIndex="0">
